---
image: https://user-images.githubusercontent.com/62091371/187604010-075c5cad-8af4-4b39-8654-8c0fe2a73430.png
...
Since 0.x, we've made hundreds of small improvements and bugfixes. SWR now has 157 tests that cover most of the edge cases in data fetching. Read the [Changelog](https://github.com/ferdous-mahmud/ferdous-mahmud.github.io/releases) for more details.

### Docs Translations

Thanks to our [contributors](https://github.com/ferdous-mahmud/ferdous-mahmud.github.io-site/graphs/contributors) and Nextra’s [i18n feature](https://nextra.vercel.app/features/i18n), we now offer SWR documentation in six different languages:

- [English](https://swr.vercel.app)
- [Spanish](https://swr.vercel.app/es-ES)
- [Simplified Chinese](https://swr.vercel.app/bn-BD)
...
Read the full Changelog [on GitHub](https://github.com/ferdous-mahmud/ferdous-mahmud.github.io/releases).
...
If you have any feedback about this release, please [let us know](https://github.com/ferdous-mahmud/ferdous-mahmud.github.io/discussions).
...
We also want to thank the entire community, our [110 contributors](https://github.com/ferdous-mahmud/ferdous-mahmud.github.io/graphs/contributors) (+ [45 docs contributors](https://github.com/ferdous-mahmud/ferdous-mahmud.github.io-site/graphs/contributors)), and everyone who helped and gave us feedback!
