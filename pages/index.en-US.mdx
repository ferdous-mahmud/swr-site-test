...
{<h1 className="text-center font-extrabold md:text-5xl mt-8">Ferdous Mahmud Akash</h1>}
...
<div className="mt-16 mb-20 text-center">
  [Get Started](/docs/getting-started) · [Projects](/projects/basic) · [Blog](/blog/swr-v1) · [GitHub Repository](https://github.com/ferdous-mahmud)
</div>
...
Feel free to join the [discussions on GitHub](https://github.com/ferdous-mahmud/discussions)!
