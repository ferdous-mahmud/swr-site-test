...
<div className="mt-16 mb-20 text-center">
  [入门](/docs/getting-started) · [示例](/projects/basic) · [博客](/blog/swr-v1) · [GitHub 仓库](https://github.com/ferdous-mahmud)
</div>
...
欢迎加入 [GitHub 上的讨论](https://github.com/ferdous-mahmud/discussions)！
